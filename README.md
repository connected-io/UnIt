...
## Warning
This library uses the black magic of swizzling for one of the extensions (capturing constraints). Please be cognizant of this as first Apple can change the underlying objective-C private method that this extension swizzles anytime. In addition, you will most likely get an App Store rejection if this framework is included in your app target. It's recommended to keep this framework only in your test target.
